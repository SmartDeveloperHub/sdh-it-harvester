...
public final class VersionKey implements Comparable<VersionKey>, Serializable {
	...
	public VersionKey(final String projectId, final String versionId) {
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.projectId,this.versionId);
	}
	...
	public boolean equals(final Object obj) {
		...
		if(obj instanceof VersionKey) {
			final VersionKey that=(VersionKey)obj;
			result=
	...
	@Override
	public int compareTo(final VersionKey key) {
		int result=this.projectId.compareTo(key.projectId);
		if(result==0) {
			result=this.versionId.compareTo(key.versionId);
		}
		return result;
	}
