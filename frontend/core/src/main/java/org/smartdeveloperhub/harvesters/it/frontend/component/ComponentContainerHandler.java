...
@DirectContainer(
	id = ComponentContainerHandler.ID,
	memberHandler = ComponentHandler.class,
	membershipPredicate="http://www.smartdeveloperhub.org/vocabulary/it#hasComponent"
)
public class ComponentContainerHandler extends AbstractCappedContainerHandler {

	public static final String ID   = "ComponentContainerHandler";

	public ComponentContainerHandler() {
		super("component");
	}
