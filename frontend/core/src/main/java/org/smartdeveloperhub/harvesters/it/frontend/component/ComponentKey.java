...
public final class ComponentKey implements Comparable<ComponentKey>, Serializable {
	...
	public ComponentKey(final String projectId, final String componentId) {
	...
	public boolean equals(final Object obj) {
		...
		if(obj instanceof ComponentKey) {
			final ComponentKey that=(ComponentKey)obj;
			result=
	...
	@Override
	public int compareTo(final ComponentKey key) {
