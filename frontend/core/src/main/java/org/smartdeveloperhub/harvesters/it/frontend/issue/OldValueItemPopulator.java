...
final class OldValueItemPopulator extends ItemPopulator {

	OldValueItemPopulator(final Issue issue, final IndividualHelper item, final String property) {
		super(issue,item,property);
	}

	@Override
	protected <V> V getValue(final AbstractItem<V> aItem) {
		return aItem.getOldValue();
	}
