...
@DirectContainer(
	id = ContributorContainerHandler.ID,
	memberHandler = ContributorHandler.class,
	membershipPredicate=IT.HAS_CONTRIBUTOR
)
public class ContributorContainerHandler extends AbstractCappedContainerHandler {

	public static final String ID = "ContributorContainerHandler";

	public ContributorContainerHandler() {
		super("contributor");
	}
