...
public class IssueContainerHandlerTest extends AbstractCappedContainerHandlerTestHelper {

	@Test
	public void testGet() throws Exception {
		super.verifyGetReturnsEmptyDataset(new IssueContainerHandler());
	}

	@Test
	public void testCreate() throws Exception {
		super.verifyFactoryMethodIsDisabled("issue",new IssueContainerHandler());
	}
