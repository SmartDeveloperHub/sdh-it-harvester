...
public class FailingBackendControllerFactory implements BackendControllerFactory {

	@Override
	public BackendController create(final URI target) {
		throw new IllegalStateException("Could not create controller");
	}

	@Override
	public String toString() {
		return "BackendControllerFactory[failing]";
	}
