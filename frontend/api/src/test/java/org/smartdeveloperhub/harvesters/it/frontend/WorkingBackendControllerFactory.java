...
public class WorkingBackendControllerFactory implements BackendControllerFactory {
	...
	public String toString() {
		return "BackendControllerFactory["+controller+"]";
	}

	static void setController(final BackendController controller) {
		WorkingBackendControllerFactory.controller = controller;
	}
